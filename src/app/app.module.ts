...
function sendToLoginPage(oktaAuth: OktaAuth, injector: Injector){
  // Dùng injector để access bất kì service nào available trog app
...
@NgModule({
  ...
  providers: [
    ProductService,
    {provide: OKTA_CONFIG, useValue: { oktaAuth }}, {provide: HTTP_INTERCEPTORS, useClass: AuthInterceptorService, multi: true}
  ],
